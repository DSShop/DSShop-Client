...
Make sure you pick 3DS Development and NDS Development when using the graphical installer on Windows.<br>
...
<p align="center">DSShop Team for the development, devkitPro for the devkitARM toolchain and NDS/3DS libraries and Nintendo(not affiliated with this project).</p>
